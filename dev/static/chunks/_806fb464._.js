...
function RotatingCarousel({ items, width = 190, height = 254, sensitivity = 0.15, className }) {
    ...
    const [shuffledItems, setShuffledItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(items);
...
_s(RotatingCarousel, "jW6d11/KeDRvOF66UMQrm58A6oY=");
_c = RotatingCarousel;
var _c;
...
"[project]/components/useCollabLensData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useCollabLensData = ()=>{
    _s();
    const [figures, setFigures] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
...
_s(useCollabLensData, "oPLfsLobLWQl6IPySDsqbANAloA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/data/carousel-items.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$rotating$2d$carousel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/rotating-carousel.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$useCollabLensData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/useCollabLensData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$carousel$2d$items$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/carousel-items.ts [app-client] (ecmascript)");
...
function DashboardPage() {
    ...
    const { fetchRepoData, figures, timeline, roles, loading, error, repository } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$useCollabLensData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollabLensData"])();
    ...
    const carouselData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[carouselData]": ()=>{
            if (figures.length > 0 && Object.keys(roles).length > 0) {
                ...
                if (timeline.length > 0) {
                    ...
                    figures.forEach({
                        "DashboardPage.useMemo[carouselData]": (figure)=>{
                            const role = Object.entries(roles).find({
                                "DashboardPage.useMemo[carouselData].role": ([key, value])=>{
                                    if (Array.isArray(value)) {
                                        return value.some({
                                            "DashboardPage.useMemo[carouselData].role": (f)=>f.username === figure.username
                                        }["DashboardPage.useMemo[carouselData].role"]);
                                    }
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$carousel$2d$items$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["carouselItems"] // Default placeholder data
            ;
        }
    }["DashboardPage.useMemo[carouselData]"], [
        figures,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$rotating$2d$carousel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RotatingCarousel"], {
                items: carouselData,
                width: 190,
                height: 254,
                sensitivity: 0.3
...
_s(DashboardPage, "m2qF87a+6A+VcRGWlD85mNiXtgM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$useCollabLensData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollabLensData"]
    ];
});
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_806fb464._.js.map